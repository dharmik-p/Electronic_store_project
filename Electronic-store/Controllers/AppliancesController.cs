...
namespace Electronic_store.Controllers
{
    public class AppliancesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Catagory,Price,Brand")] Appliance appliance)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Catagory,Price,Brand")] Appliance appliance)
        {
            if (ModelState.IsValid)
            {
